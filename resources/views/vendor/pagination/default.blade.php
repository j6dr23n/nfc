@if ($paginator->hasPages())
    <ul class="pagination product-pagination ms-auto float-end">
        ...
        @if ($paginator->onFirstPage())
            <li class="page-item disabled page-prev" aria-disabled="true" aria-label="@lang('pagination.previous')">
                <a class="page-link" href="javascript:void(0);" tabindex="-1">&lsaquo;</a>
            </li>
        @else
            <li class="page-item">
        ...
        @else
            <li class="page-item disabled page-next" aria-disabled="true" aria-label="@lang('pagination.next')">
